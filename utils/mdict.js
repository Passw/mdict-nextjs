...
const MCommon = require("./mdict-common").common
const MParser = require("./mdict-parser").load
const MRenderer = require("./mdict-renderer").renderer

console.log("mdict.js loaded..")
