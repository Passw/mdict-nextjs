...
const lzo1x = require("./minilzo-decompress").lzo1x
const lzo = lzo1x
const Promise = require("bluebird");
const ripemd128 = require("./ripemd128").ripemd128
const parseXml = require("./mdict-parseXml").parseXml
const common = require("./mdict-common").common

const parserer = function(pako, lzo, ripemd128, Promise, parseXml, common) {
    // Value of undefined.
    ...
    function sliceThen(file, offset, len) {
        var p = new Promise(function(_resolve) {
            ...
            _resolve(file.slice(offset, offset + len))
        });
...
const pa = parserer(pako, lzo, ripemd128, Promise, parseXml, common)
